...
knc_final.fit(x_train_final, y_train_final)
knc_final.score(x_test_final, y_test_final)*100

knc_final_ypred = knc_final.predict(x_test_final)
knc_final_f1 = f1_score(knc_final_ypred, y_test_final, average='macro')*100
knc_final_cr = classification_report(knc_final_ypred, y_test_final)
